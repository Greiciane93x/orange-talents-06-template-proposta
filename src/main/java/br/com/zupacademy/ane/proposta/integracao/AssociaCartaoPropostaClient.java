...
import br.com.zupacademy.ane.proposta.carteiradigital.AssociaCartaoCarteiraForm;
...
public interface AssociaCartaoPropostaClient {
     ...
     Map<Object, ?> verificaAssociacao(@PathVariable("id") Long idProposta, @RequestBody AssociaCartaoCarteiraForm form);
